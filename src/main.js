...
const BlizApp = (request, response, RouterCreator, Listen, defaultHandler, midHandler, PathCreator, http, urlUtil, populateRoutersUtil, handleNestedRoutersUtil, populateUrlOptions, createHandler, GetObjProps, populateSubAppsUtil, treeify) => {
  const Instance = {}
  const middleWares = []
  const routersObject = {}
  const subApps = []
...
const BlizCreator = () => {
  return Object.assign(
    {},
    BlizApp(request, response, RouterCreator, Listen, defaultHandler, midHandler, PathCreator, http, urlUtil, populateRoutersUtil, handleNestedRoutersUtil, populateUrlOptions, createHandler, GetObjProps, populateSubAppsUtil, treeify)
  )
}
