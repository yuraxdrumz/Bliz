...
const PathCreator = path => {
  ...
  return Object.assign(
    _PathReturn,
    AssignHandler({name: 'describe', obj: _pathData.describe, chainLink: _PathReturn, override: true}),
    AssignHandler({name: 'parent', obj: _pathData.parent, chainLink: _PathReturn, override: true}),
