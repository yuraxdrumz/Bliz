...
/***/ "./examples/http-example/index.js":
/*!****************************************!*\
  !*** ./examples/http-example/index.js ***!
  \****************************************/
...
var _slash = __webpack_require__(/*! ./slash.router */ "./examples/http-example/slash.router.js");
...
app.registerRouters((0, _slash2.default)(app)).prettyPrint()
// .describe({
//   title:'my api', 
//   version:'1.0.1', 
...
.middleware(_bodyParser2.default.json()).listen(4000);

/***/ }),

/***/ "./examples/http-example/schemas.js":
/*!******************************************!*\
  !*** ./examples/http-example/schemas.js ***!
  \******************************************/
/*! no static exports found */
...
exports.errorSchema = exports.querySchema = exports.responseSchema = exports.otherSchema = exports.statusSchema = exports.paramSchema = undefined;

var _main = __webpack_require__(/*! ../../src/main */ "./src/main.js");

var bodySchema = (0, _main.struct)({
  name: 'string',
  last_name: 'string',
  address: 'string?'
});

var paramSchema = exports.paramSchema = (0, _main.struct)({
  param: 'string?',
  body: bodySchema
});
var statusSchema = exports.statusSchema = (0, _main.struct)({
  status: 'string'
});

var otherSchema = exports.otherSchema = (0, _main.struct)({
  lala: 'number'
});

var responseSchema = exports.responseSchema = (0, _main.struct)({
  data: otherSchema
});

var querySchema = exports.querySchema = (0, _main.struct)({
  ggg: 'string'
});

var errorSchema = exports.errorSchema = (0, _main.struct)({
  error: 'string'
});

/***/ }),

/***/ "./examples/http-example/slash.router.js":
/*!***********************************************!*\
  !*** ./examples/http-example/slash.router.js ***!
  \***********************************************/
/*! no static exports found */
...
exports.default = slashRouter;

var _status = __webpack_require__(/*! ./status.handler */ "./examples/http-example/status.handler.js");

var _status2 = _interopRequireDefault(_status);

var _test = __webpack_require__(/*! ./test.handler */ "./examples/http-example/test.handler.js");

var _test2 = _interopRequireDefault(_test);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function slashRouter(app) {
  return app.createRouter('/api/').post((0, _status2.default)(app)).post((0, _test2.default)(app)).middleware(function (req, res, next) {
    console.log('hit /api');
    next();
  });
}
...
/***/ "./examples/http-example/status.handler.js":
/*!*************************************************!*\
  !*** ./examples/http-example/status.handler.js ***!
  \*************************************************/
/*! no static exports found */
...
var _schemas = __webpack_require__(/*! ./schemas */ "./examples/http-example/schemas.js");

function statusHandler(app) {
  return app.createPath('/:status/').handler(function (req, res) {
    ...
    incoming: [{ in: 'body', schema: _schemas.paramSchema }, { in: 'path', schema: _schemas.statusSchema }],
    outgoing: [{ status: 200, schema: _schemas.responseSchema }, { status: 400, schema: _schemas.errorSchema }]
  });
}

/***/ }),

/***/ "./examples/http-example/test.handler.js":
/*!***********************************************!*\
  !*** ./examples/http-example/test.handler.js ***!
  \***********************************************/
/*! no static exports found */
...
function testHandler(app) {
  return app.createPath('/test/:param').handler(function (req, res) {
    return res.json({ params: req.params, query: req.query, files: req.files });
  }).describe({
    tags: ['main route', 'simple tag'],
    summary: 'simple summary for swagger',
    description: 'returns whatever it receives',
    incoming: [{ in: 'path', schema: _schemas.paramSchema }, { in: 'query', schema: _schemas.querySchema }],
    outgoing: [{ status: 200, schema: _schemas.responseSchema }, { status: 400, schema: _schemas.errorSchema }]
...
exports.StructError = exports.superstruct = exports.struct = exports.response = exports.request = undefined;
